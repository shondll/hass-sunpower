...
SUNPOWER_SENSORS = {
    PVS_DEVICE_TYPE: {
        ...
        "sensors": {
            "PVS_HW_VERSION": {
                "field": "/sys/info/hwrev",
                "title": "{SUN_POWER}{MODEL} {SERIAL} Hardware Version",
                "icon": "mdi:information-outline",
                "device": None,
                "entity_category": EntityCategory.DIAGNOSTIC,
            },
            "PVS_SW_VERSION": {
                "field": "/sys/info/sw_rev",
                "title": "{SUN_POWER}{MODEL} {SERIAL} Software Version",
                "icon": "mdi:information-outline",
                "device": None,
                "entity_category": EntityCategory.DIAGNOSTIC,
            },
            "PVS_UPTIME": {
                "field": "/sys/info/uptime",
